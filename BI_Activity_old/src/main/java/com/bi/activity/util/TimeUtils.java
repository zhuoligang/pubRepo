...
public class TimeUtils {
  ...
  public static final SimpleDateFormat DATE_FORMAT_DATE_M =
      new SimpleDateFormat("yyyy/MM/dd HH:mm");
  public static final SimpleDateFormat DATE_FORMAT_DATE_S = new SimpleDateFormat(
      "yyyy/MM/dd HH:mm:ss");
